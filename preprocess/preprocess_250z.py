...
fname_pattern = path_to_data + 'downloads/ERA5/huv/6hr/era5_ak_025dg_6hr_huv_*.nc'
...
for i, ar_dates in enumerate(ardate_lst):
    ...
    # write to netCDF
    fname = os.path.join(path_to_data, 'preprocessed/ERA5_250Z_daily_{0}.nc'.format(community_lst[i]))
